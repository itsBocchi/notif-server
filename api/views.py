...
from server.models import Notification, ApiKey
    ...
    try:
        ...
        return JsonResponse({
            ...
            'permissions': {
                ...
                'can_update_alerts': api_key_obj.role == 'admin',
                'can_delete_alerts': api_key_obj.role == 'admin',
                'can_manage_api_keys': api_key_obj.role == 'admin'
            },
