...
python scripts/create_api_key.py "Sistema de Alertas"
```
...
```bash
python scripts/test_fire_alert.py <api_key> "USM Sede Viña del Mar" "Incendio detectado" -33.037542 -71.485482 true
```

### Alerta de Terremoto

```bash
python scripts/test_earthquake_alert.py <api_key> "Quilpué, Chile" "Terremoto de magnitud 7.5" 7.5 -33.050708 -71.435072 false
```
