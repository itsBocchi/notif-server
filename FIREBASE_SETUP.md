...
3. **Configurar el proyecto**
   ...
   - Renómbralo a `alertduckaccountkey.json` o actualiza la variable de entorno `FIREBASE_CREDENTIALS_PATH` en el archivo `.env`

4. **Verificar la configuración**
   - Reinicia el servidor Django
   - Deberías ver el mensaje "Firebase initialized successfully with credentials from alertduckaccountkey.json"
